...
|----------|---------|------|
| `notebooks/01-feast-features.ipynb` | Data → Feast apply → Materialize | ~2 min |
| `notebooks/02-training.ipynb` | Distributed training (Kubeflow) | ~3 min |
| `notebooks/03-inference.ipynb` | Model serving test | ~1 min |
